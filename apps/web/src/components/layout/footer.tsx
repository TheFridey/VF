        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-6">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 leading-relaxed">
              A safe space for the UK veteran community — built by veterans, for veterans.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/app/premium" className="text-xs text-gray-500 hover:text-green-400 transition-colors">Membership Plans</Link></li>
            </ul>
          </div>
        </div>
